...
const std::vector<Category> CATEGORIES{
    ...
    {"Pattern",
     ...
     {{"Wildcard", {}},
      ...
      {"Record", {"[RecRowPattern*] rows", "bool has_wildcard=false"}},
      {"List", {"[Pattern*] patterns"}},
      {"Tuple", {"[Pattern*] patterns"}},
      {"Datatype", {"IdentifierPattern* constructor", "Pattern* arg"}},
      {"Layered", {"str identifier", "Pattern* pattern"}},
      {"Typed", {"Pattern* pattern", "TypeExpr* type"}}}},
    {"Expr",
     "EXPR",
     {
