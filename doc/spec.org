...
| ~\U~ nnnnnnnn   | arbitrary unicode codepoint (hex) |
...
A character literal is any escape sequence or any character except
~'~, ~\~, or the newline character, enclosed in single quotes.
